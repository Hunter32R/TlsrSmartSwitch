...
* Attribute 0x2200: Coefficient for calculating _current_ – значение коэффициента множителя для счетчика тока. По умолчанию равен 16860520.
* Attribute 0x2201: Coefficient for calculating _voltage_ – значение коэффициента множителя для счетчика напряжения. По умолчанию равен 26927694.
* Attribute 0x2202: Coefficient for calculating _power_ – значение коэффициента множителя для счетчика мощности. По умолчанию равен 27060025.
* Attribute 0x2203: Coefficient for calculating _energy_ – значение коэффициента множителя для счетчика энергии. По умолчанию равен 315272310.
* Attribute 0x2204: Coefficient for calculating _freq_ – значение коэффициента для счетчика частоты. По умолчанию равен 100000000.
...
Точность соотношений зависит от разбросов в попавшемся чипе BL0942.
